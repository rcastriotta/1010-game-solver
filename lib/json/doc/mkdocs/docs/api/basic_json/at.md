...
1. The function can throw the following exceptions:
    - Throws [`type_error.304`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptiontype_error304) if the JSON value is not an array;
      in this case, calling `at` with an index makes no sense. See example below.
    - Throws [`out_of_range.401`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range401) if the index `idx` is out of
      range of the array; that is, `idx >= size()`. See example below.
2. The function can throw the following exceptions:
    - Throws [`type_error.304`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptiontype_error304) if the JSON value is not an object;
      in this case, calling `at` with a key makes no sense. See example below.
    - Throws [`out_of_range.403`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range403) if the key `key` is not
      stored in the object; that is, `find(key) == end()`. See example below.
3. The function can throw the following exceptions:
    - Throws [`parse_error.106`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionparse_error106) if an array index in the passed
      JSON pointer `ptr` begins with '0'. See example below.
    - Throws [`parse_error.109`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionparse_error109) if an array index in the passed
      JSON pointer `ptr` is not a number. See example below.
    - Throws [`out_of_range.401`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range401) if an array index in the passed
      JSON pointer `ptr` is out of range. See example below.
    - Throws [`out_of_range.402`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range402) if the array index '-' is used
    ...
    - Throws [`out_of_range.403`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range403) if the JSON pointer describes a
      key of an object which cannot be found. See example below.
    - Throws [`out_of_range.404`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/home/exceptions.md#jsonexceptionout_of_range404) if the JSON pointer `ptr` can
...
- see [`operator[]`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/api/basic_json/operator[].md) for unchecked access by reference
- see [`value`](Desktop/1010-ai-master/lib/json/doc/mkdocs/docs/api/basic_json/value.md) for access with default value
