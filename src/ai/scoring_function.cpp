...
const scoring_table_t fullScoringTable {
    ...
    {game::newFive.id,              1.00f /  64},
    {game::newOne.id,               0.15f /  72},
    {game::newTwo.id,               0.15f /  72},
    {game::newThree.id,             0.15f /  72},
    {game::newFour.id,              0.15f /  72},
    {game::newSix.id,               0.25f /  72},
    {game::newSeven.id,             0.25f /  72},
    {game::newEight.id,             0.25f /  72},
    {game::newNine.id,              0.25f /  72},
    {game::newTen.id,               0.25f /  72},
    {game::newEleven.id,            0.25f /  72},
    {game::newTwelve.id,            0.25f /  72},
    {game::newThirteen.id,          0.25f /  72},
    {game::newFourteen.id,          0.25f /  72},
    {game::newFifteen.id,           0.25f /  72},
...
const scoring_table_t customScoringTable {
    ...
    {game::newThree.id,             0.15f /  72},
    {game::newFour.id,              0.15f /  72},
    {game::newSix.id,               0.15f /  72},
    {game::newSeven.id,             0.15f /  72},
    {game::newEight.id,             0.15f /  72},
    {game::newNine.id,              0.15f /  72},
    {game::newTen.id,               0.25f /  72},
    {game::newEleven.id,            0.25f /  72},
    {game::newTwelve.id,            0.25f /  72},
    {game::newThirteen.id,          0.25f /  72},
