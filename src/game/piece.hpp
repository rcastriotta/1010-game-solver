...
extern const Piece newOne;
extern const Piece newTwo;
extern const Piece newThree;
extern const Piece newFour;
extern const Piece newFive;
extern const Piece newSix;
extern const Piece newSeven;
extern const Piece newEight;
extern const Piece newNine;
extern const Piece newTen;
extern const Piece newEleven;
extern const Piece newTwelve;
extern const Piece newThirteen;
extern const Piece newFourteen;
extern const Piece newFifteen;
// note: this array also contains pieceNone, which should never be
// presented to the user
extern const std::array<Piece, 35> allPieces;
// pieces are repeated in order to obtain an array where each piece type
// (i.e. with the same color) occurs the same times
